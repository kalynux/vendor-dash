...
export const common = {
    ...
    address: {
        ...
        locating: 'Recherche de votre position… cela peut prendre quelques secondes.',
        locationFixFailed: 'Impossible d’obtenir votre position. Placez-vous dans une zone mieux couverte et réessayez.',
        access: {
            deniedTitle: 'Autoriser l’accès à votre position',
            deniedBody: 'L’application utilise votre position uniquement pour remplir cette adresse. Touchez Autoriser, puis choisissez « Lorsque vous utilisez l’application » quand votre téléphone le demande.',
            allow: 'Autoriser',
            blockedTitle: 'La position est bloquée pour cette application',
            blockedBody: 'Votre téléphone ne le demandera plus de lui-même. Ouvrez les réglages, allez dans Autorisations → Position et choisissez « Autoriser seulement si l’application est en cours d’utilisation ». À votre retour, l’adresse se remplira toute seule.',
            blockedBrowserTitle: 'La position est bloquée pour ce site',
            blockedBrowserBody: 'Votre navigateur ne le demandera plus de lui-même. Touchez l’icône à gauche de l’adresse du site, autorisez la Position, puis touchez Réessayer.',
            offTitle: 'La localisation de votre téléphone est désactivée',
            offBody: 'Activez-la pour remplir cette adresse depuis l’endroit où vous êtes. Touchez Réessayer puis choisissez Activer — ou faites glisser le haut de l’écran vers le bas et touchez Localisation.',
            notNow: 'Plus tard',
        },
    ...
    a11y: {
        ...
        aboutThisField: 'À propos de ce champ',
